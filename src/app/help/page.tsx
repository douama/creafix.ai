...
const categories = [
  {
    icon: BookOpen,
    title: "Démarrage",
    desc: "Créer un compte, connecter ses pages, comprendre l'audit IA.",
    color: "from-violet-500 to-purple-600",
    items: [
      { q: "Comment connecter une page Facebook ?", href: "/help/connect-facebook" },
      { q: "Comment connecter un compte TikTok ?", href: "/help/connect-tiktok" },
  ...
  },
  {
    icon: HelpCircle,
    title: "Monétisation",
    desc: "Activer In-Stream Ads, devenir éligible Creator Rewards.",
    color: "from-emerald-500 to-teal-600",
    items: [
      { q: "Activer la monétisation Facebook", href: "/help/fb-monetization" },
      { q: "Devenir éligible TikTok Creator Rewards", href: "/help/tiktok-rewards" },
      { q: "Estimation revenus : comment c'est calculé", href: "/help/revenue-estimate" },
