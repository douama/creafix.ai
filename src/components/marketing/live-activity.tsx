...
const FEED: Event[] = [
  ...
  { id: 5, icon: Eye, text: "+12 400 vues prédites sur la prochaine vidéo de @amina_dakar", flag: "🇸🇳", time: "il y a 11 min", color: "#00C2FF" },
  ...
  { id: 10, icon: Sparkles, text: "Meilleur créneau Dakar mis à jour : 20h–22h", flag: "🇸🇳", time: "il y a 25 min", color: "#00C2FF" },
];
